...
<div class="popupDecline_request" x-show="show_decline_registration_form" style="display: none">
    <div class="popup-contentDecline_request">
        <div class="popup-child1" style="margin-bottom: 5px; display: flex; flex-direction: column">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 right">
                <div class="form-group">
                    <textarea class="form-control form-control-lg" x-ref="decline_message_reg" placeholder="Enter reason here..."></textarea>
                </div>
                <br>
        ...
        <br>
        <button type="button" class="btn btn-success" style="width: 50%" x-ref="declinerequest_button" x-on:click="decline_registration(f_id)">Confirm</button>
