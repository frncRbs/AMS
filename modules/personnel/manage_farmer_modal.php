        ...
        <div class="popup-child1" style="margin-bottom: 5px">
            <div style="display: flex; flex-direction: column;">
                ...
                <hr>
                    ...
                    <a href="../../controller/exports/export_farmer.php" class="btn btn-success" style="position: relative; float: right; padding-right: 20px">Generate Report</a>
                        <!-- <a href="../../controller/exports/export_farmer.php" style="float: right; padding: 5px">Generate Report</a> -->
                                        ...
                                        <template x-for="(row, index) in custom_pagination(user_details)">
                                            <tr>
                                                ...
                                                <td style="min-width: 150px; text-align: center">
                                                    ...
                                                    <template x-if="row.status == 0 && row.is_active == 1">
                                                        <h4 style="color: red; font-weight: bold">Pending</h4>
                                                    </template>
                                                    <template x-if="row.status == 2 && row.is_active == 1">
                                                ...
                                                <td style="min-width: 150px; text-align: center">
                                                    <div style="display: flex; flex-direction: flex-end; align-items: space-around">
                                                        <template x-if="row.status == 0">
                                                            <button class="btn btn-danger" style="top:0; right:0; text-decoration: none; z-index: 1; cursor: pointer; border-radius: 5em" x-on:click="show_decline_registration_form = true, f_id = row.id">Decline</button>
                                                        </template>
                                                        ...
                                                        <template x-if="row.status == 0">
                                                            <button class="btn btn-success" style="top:0; right:0; text-decoration: none; z-index: 1; cursor: pointer; border-radius: 5em" x-on:click="approve_farmer, f_id = row.id">Approve</button>
                                                        </template>
