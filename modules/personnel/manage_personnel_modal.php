    ...
    <div class="popup-contentActivate" x-data="manage_personnel_modal">
        <div class="popup-child1" style="margin-bottom: 5px">
            <div style="display: flex; flex-direction: column;">
                ...
                <hr>
                    <div style="position: relative; display: flex; justify-content: flex-end; align-items: space-between">
                        <a href="../../controller/exports/export_personnel.php" class="btn btn-success" style="position: relative; float: right; padding-right: 20px">Generate Report</a>
